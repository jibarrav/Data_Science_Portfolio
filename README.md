...
<div id="header" align="center">
  <img src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExa29xdmw1d3dmbXhjN2tsbTJncm5pMGY2aHB0ZWQ4Z2VmeThzNnIxMiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/HUplkVCPY7jTW/giphy.gif" width="300"/>
</div>
<div id="badges" align="center">
  <a href="https://www.linkedin.com/in/jibarravargas">
    <img src="https://img.shields.io/badge/LinkedIn-blue?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn Badge"/>
  </a>
</div>

<div id="views" align="center">
  <img src="https://komarev.com/ghpvc/?username=jibarrav&style=flat-square&color=blue" alt=""/>
</div>

---
<!--
Limpieza de datos | Modelado Predictivo | Dashboards Automatizados | Optimización de Procesos
-->

### 🙋‍♂️ About Me

I'm Jonathan Ibarra, an emerging data scientist delving into the world of data analysis through an intensive training program. My journey in data science is driven by my enthusiasm for uncovering valuable insights from data and applying machine learning to address real-world challenges. This repository chronicles my progress and showcases the practical skills I've developed in areas ranging from exploratory data analysis to advanced machine learning techniques.
...
- [**Sprint 2: Python Fundamentals (continued)**]() - Delve deeper into real-world data analysis tasks, enhancing your ability to handle more complex datasets and more challenging tasks. This step-by-step approach ensures you'll effectively meet client needs while progressively expanding your expertise.
  
- [**Sprint 3: Data Wrangling and Visualization**]() - Techniques in Exploratory Data Analysis (EDA), data cleaning, and visualization to uncover patterns, insights, and anomalies in data.

- [**Sprint 4: Data Wrangling and Visualization (continued)**]() - The mission is to clean the data and prepare a report that provides information about Instacart customers' purchasing habits. After answering each question, write a brief explanation of your results in a Markdown cell in your Jupyter notebook. This project will require you to create graphs that communicate your findings.  
  
- [**Sprint 5: Statistical Data Analysis**]() - Application of statistical concepts and tests to interpret data findings accurately and to understand distributions, correlations, and regression analysis.

- [**Sprint 6: Module 1 Project**]() - You work for Ice, an online store that sells video games worldwide. User and expert reviews, genres, platforms (e.g., Xbox or PlayStation), and historical sales data are available from open sources. You need to identify patterns that determine whether a game will be successful or not. This will allow you to spot promising projects and plan advertising campaigns..


### Deep Dives and Advanced Analysis

- [**Sprint 7: Software Development Tools**]() - Exploring tools and methodologies in software development including version control with Git, collaborative platforms like GitHub, and best practices in coding.
